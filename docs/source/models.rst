...
The full guide, including tutorials and detailed documentation for using the ``langchain`` flavor is available at `this location <llms/langchain/index.html>`_.
